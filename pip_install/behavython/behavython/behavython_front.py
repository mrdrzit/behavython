...
class behavython_gui(QMainWindow):
    ...
    def __init__(self):
        ...
        loader.registerCustomWidget(behavython_plot_widget.plot_viewer)
        ...
        self.interface.folder_structure_check_button.clicked.connect(
            lambda: dlc_helper_functions.folder_structure_check_function(self)
        )
        self.interface.dlc_video_analyze_button.clicked.connect(lambda: dlc_helper_functions.dlc_video_analyze_function(self))
        self.interface.extract_skeleton_button.clicked.connect(lambda: dlc_helper_functions.extract_skeleton_function(self))
        self.interface.clear_unused_files_button.clicked.connect(lambda: dlc_helper_functions.clear_unused_files_function(self))
        self.interface.get_config_path_button.clicked.connect(
            lambda: dlc_helper_functions.get_folder_path_function(self, "config_path")
        )
        self.interface.get_videos_path_button.clicked.connect(
            lambda: dlc_helper_functions.get_folder_path_function(self, "videos_path")
        )
        self.interface.get_frames_button.clicked.connect(lambda: dlc_helper_functions.get_frames_function(self))
