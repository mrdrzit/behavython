from Widgets.custom_widgets import plot_viewer_function
import sys
import os
...
class behavython_gui(QMainWindow):
    ...
    def __init__(self):
        ...
        uic.loadUi(load_gui_path, self, package='Widgets')               # Loads the interface design archive (made in Qt Designer)
        self.show()
